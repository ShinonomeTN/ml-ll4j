        ...
        for (final String s : model) {
            ...
            switch (type) {
                ...
                case "D": {
                    ...
                    layers.add(new Layer(type, meta, data, Matrix.Transform.Dense));
                    break;
                }
                ...
                case "L": {
                    ...
                    layers.add(new Layer(type, meta, data, Matrix.Transform.LeakyRelu));
                    break;
                }
                // For "Judge Layer"
                case "J": {
                    final int[] meta = new int[]{inputCount, 1}; // It only output a single number
                    layers.add(new Layer(type, meta, new double[1], Matrix.Transform.Judge));
                    break;
                }
